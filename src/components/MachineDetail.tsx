      ...
      {activeTab === 'Capteurs' && (
        <div className="grid grid-cols-1 gap-4">
          <div className="bg-slate-800/50 border border-white/[0.08] rounded-xl p-5">
            ...
            {/* Vibration */}
            {[
              { label: 'Vibration',          tags: [['ADXL345','#3b82f6'],['GPIO21/22 I2C','#06b6d4']], value: live.vibration, color: '#3b82f6', pct: vibPct },
              { label: 'Courant électrique', tags: [['SCT-013','#f97316'],['GPIO34 ADC','#a855f7']],    value: live.courant,   color: '#f97316', pct: couPct },
              { label: 'Vitesse rotation',   tags: [['Hall Sensor','#22c55e'],['GPIO35','#06b6d4']],    value: live.rpm,       color: '#22c55e', pct: rpmPct },
            ].map((m, i) => (
