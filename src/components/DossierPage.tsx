...
const DossierPage: React.FC<DossierPageProps> = ({ showAddPieceActions = false, onAddPieceFromDossier }) => {
  ...
  const theme = useMemo(() => ({
    pageTitle: 'var(--app-heading)',
    bodyText: 'var(--app-muted)',
    strongText: 'var(--app-text)',
    cardBg: 'var(--app-card)',
    subCardBg: 'var(--app-card)',
    nestedBg: 'var(--app-inset)',
    softBg: 'var(--app-card-alt)',
    border: 'var(--app-border)',
    borderSoft: 'var(--app-border)',
    inputBg: 'var(--app-surface-strong)',
    inputText: 'var(--app-text)',
    label: 'var(--app-text)',
    buttonBg: 'var(--app-surface)',
    buttonText: 'var(--app-text)',
    buttonBorder: 'var(--app-border)',
    blueShadow: 'none',
    badgeBg: 'var(--app-surface)',
    badgeText: 'var(--app-text)',
